...
export class InitialMigration1741942615938 implements MigrationInterface {
    name = 'InitialMigration1741942615938'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."trades_status_enum" AS ENUM('pending', 'assigned', 'completed', 'cancelled', 'disputed')`);
        ...
        await queryRunner.query(`ALTER TABLE "escalated_trades" ADD CONSTRAINT "FK_17cef794c1aef3c1919b4528046" FOREIGN KEY ("trade_id") REFERENCES "trades"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" ADD CONSTRAINT "FK_8c42fe52f5d531efc84622a87d9" FOREIGN KEY ("assignedCcAgentId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" ADD CONSTRAINT "FK_a809e3f9509e9f7eace6f5ee411" FOREIGN KEY ("chatId") REFERENCES "chats"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" ADD CONSTRAINT "FK_2b008f9d67bd698b77dc1717e39" FOREIGN KEY ("assignedPayerId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" ADD CONSTRAINT "FK_6689446c184e3d589610c852234" FOREIGN KEY ("escalatedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "escalated_trades" DROP CONSTRAINT "FK_6689446c184e3d589610c852234"`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" DROP CONSTRAINT "FK_2b008f9d67bd698b77dc1717e39"`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" DROP CONSTRAINT "FK_a809e3f9509e9f7eace6f5ee411"`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" DROP CONSTRAINT "FK_8c42fe52f5d531efc84622a87d9"`);
        await queryRunner.query(`ALTER TABLE "escalated_trades" DROP CONSTRAINT "FK_17cef794c1aef3c1919b4528046"`);
        ...
        await queryRunner.query(`DROP TABLE "escalated_trades"`);
        await queryRunner.query(`DROP TYPE "public"."escalated_trades_platform_enum"`);
        await queryRunner.query(`DROP TYPE "public"."escalated_trades_status_enum"`);
